...
namespace TV.Danmaku.Ijk.Media.Player.Misc {
	...
	public partial interface ITrackInfo : IJavaObject {
		...
		global::TV.Danmaku.Ijk.Media.Player.Misc.IMediaFormat Format {
			...
			[Register ("getFormat", "()Ltv/danmaku/ijk/media/player/misc/IMediaFormat;", "GetGetFormatHandler:TV.Danmaku.Ijk.Media.Player.Misc.ITrackInfoInvoker, Binding_IjkplayerJava")] get;
		}
		...
		string InfoInline {
			...
			[Register ("getInfoInline", "()Ljava/lang/String;", "GetGetInfoInlineHandler:TV.Danmaku.Ijk.Media.Player.Misc.ITrackInfoInvoker, Binding_IjkplayerJava")] get;
		}
		...
		string Language {
			...
			[Register ("getLanguage", "()Ljava/lang/String;", "GetGetLanguageHandler:TV.Danmaku.Ijk.Media.Player.Misc.ITrackInfoInvoker, Binding_IjkplayerJava")] get;
		}
		...
		int TrackType {
			...
			[Register ("getTrackType", "()I", "GetGetTrackTypeHandler:TV.Danmaku.Ijk.Media.Player.Misc.ITrackInfoInvoker, Binding_IjkplayerJava")] get;
		}
