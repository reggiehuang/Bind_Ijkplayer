...
namespace TV.Danmaku.Ijk.Media.Player.Misc {
	...
	public partial class IjkMediaFormat : global::Java.Lang.Object, global::TV.Danmaku.Ijk.Media.Player.Misc.IMediaFormat {
		...
		// Metadata.xml XPath class reference: path="/api/package[@name='tv.danmaku.ijk.media.player.misc']/class[@name='IjkMediaFormat.Formatter']"
		[global::Android.Runtime.Register ("tv/danmaku/ijk/media/player/misc/IjkMediaFormat$Formatter", DoNotGenerateAcw=true)]
		public abstract partial class Formatter : global::Java.Lang.Object {

			internal static new IntPtr java_class_handle;
			internal static new IntPtr class_ref {
				get {
					return JNIEnv.FindClass ("tv/danmaku/ijk/media/player/misc/IjkMediaFormat$Formatter", ref java_class_handle);
				}
			}
			...
			protected override global::System.Type ThresholdType {
				get { return typeof (Formatter); }
			}

			protected Formatter (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

			static Delegate cb_getDefaultString;
#pragma warning disable 0169
			static Delegate GetGetDefaultStringHandler ()
			{
				if (cb_getDefaultString == null)
					cb_getDefaultString = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr>) n_GetDefaultString);
				return cb_getDefaultString;
			}

			static IntPtr n_GetDefaultString (IntPtr jnienv, IntPtr native__this)
			{
				global::TV.Danmaku.Ijk.Media.Player.Misc.IjkMediaFormat.Formatter __this = global::Java.Lang.Object.GetObject<global::TV.Danmaku.Ijk.Media.Player.Misc.IjkMediaFormat.Formatter> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
				return JNIEnv.NewString (__this.DefaultString);
			}
#pragma warning restore 0169

			static IntPtr id_getDefaultString;
			protected virtual unsafe string DefaultString {
				// Metadata.xml XPath method reference: path="/api/package[@name='tv.danmaku.ijk.media.player.misc']/class[@name='IjkMediaFormat.Formatter']/method[@name='getDefaultString' and count(parameter)=0]"
				[Register ("getDefaultString", "()Ljava/lang/String;", "GetGetDefaultStringHandler")]
				get {
					if (id_getDefaultString == IntPtr.Zero)
						id_getDefaultString = JNIEnv.GetMethodID (class_ref, "getDefaultString", "()Ljava/lang/String;");
					try {

						if (((object) this).GetType () == ThresholdType)
							return JNIEnv.GetString (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_getDefaultString), JniHandleOwnership.TransferLocalRef);
						else
							return JNIEnv.GetString (JNIEnv.CallNonvirtualObjectMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getDefaultString", "()Ljava/lang/String;")), JniHandleOwnership.TransferLocalRef);
					} finally {
					}
				}
			}

			static Delegate cb_doFormat_Ltv_danmaku_ijk_media_player_misc_IjkMediaFormat_;
#pragma warning disable 0169
			static Delegate GetDoFormat_Ltv_danmaku_ijk_media_player_misc_IjkMediaFormat_Handler ()
			{
				if (cb_doFormat_Ltv_danmaku_ijk_media_player_misc_IjkMediaFormat_ == null)
					cb_doFormat_Ltv_danmaku_ijk_media_player_misc_IjkMediaFormat_ = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr, IntPtr>) n_DoFormat_Ltv_danmaku_ijk_media_player_misc_IjkMediaFormat_);
				return cb_doFormat_Ltv_danmaku_ijk_media_player_misc_IjkMediaFormat_;
			}

			static IntPtr n_DoFormat_Ltv_danmaku_ijk_media_player_misc_IjkMediaFormat_ (IntPtr jnienv, IntPtr native__this, IntPtr native_p0)
			{
				global::TV.Danmaku.Ijk.Media.Player.Misc.IjkMediaFormat.Formatter __this = global::Java.Lang.Object.GetObject<global::TV.Danmaku.Ijk.Media.Player.Misc.IjkMediaFormat.Formatter> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
				global::TV.Danmaku.Ijk.Media.Player.Misc.IjkMediaFormat p0 = global::Java.Lang.Object.GetObject<global::TV.Danmaku.Ijk.Media.Player.Misc.IjkMediaFormat> (native_p0, JniHandleOwnership.DoNotTransfer);
				IntPtr __ret = JNIEnv.NewString (__this.DoFormat (p0));
				return __ret;
			}
#pragma warning restore 0169

			// Metadata.xml XPath method reference: path="/api/package[@name='tv.danmaku.ijk.media.player.misc']/class[@name='IjkMediaFormat.Formatter']/method[@name='doFormat' and count(parameter)=1 and parameter[1][@type='tv.danmaku.ijk.media.player.misc.IjkMediaFormat']]"
			[Register ("doFormat", "(Ltv/danmaku/ijk/media/player/misc/IjkMediaFormat;)Ljava/lang/String;", "GetDoFormat_Ltv_danmaku_ijk_media_player_misc_IjkMediaFormat_Handler")]
			protected abstract string DoFormat (global::TV.Danmaku.Ijk.Media.Player.Misc.IjkMediaFormat p0);

			static Delegate cb_format_Ltv_danmaku_ijk_media_player_misc_IjkMediaFormat_;
#pragma warning disable 0169
			static Delegate GetFormat_Ltv_danmaku_ijk_media_player_misc_IjkMediaFormat_Handler ()
			{
				if (cb_format_Ltv_danmaku_ijk_media_player_misc_IjkMediaFormat_ == null)
					cb_format_Ltv_danmaku_ijk_media_player_misc_IjkMediaFormat_ = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr, IntPtr>) n_Format_Ltv_danmaku_ijk_media_player_misc_IjkMediaFormat_);
				return cb_format_Ltv_danmaku_ijk_media_player_misc_IjkMediaFormat_;
			}

			static IntPtr n_Format_Ltv_danmaku_ijk_media_player_misc_IjkMediaFormat_ (IntPtr jnienv, IntPtr native__this, IntPtr native_p0)
			{
				global::TV.Danmaku.Ijk.Media.Player.Misc.IjkMediaFormat.Formatter __this = global::Java.Lang.Object.GetObject<global::TV.Danmaku.Ijk.Media.Player.Misc.IjkMediaFormat.Formatter> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
				global::TV.Danmaku.Ijk.Media.Player.Misc.IjkMediaFormat p0 = global::Java.Lang.Object.GetObject<global::TV.Danmaku.Ijk.Media.Player.Misc.IjkMediaFormat> (native_p0, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
			...
			static IntPtr id_format_Ltv_danmaku_ijk_media_player_misc_IjkMediaFormat_;
			// Metadata.xml XPath method reference: path="/api/package[@name='tv.danmaku.ijk.media.player.misc']/class[@name='IjkMediaFormat.Formatter']/method[@name='format' and count(parameter)=1 and parameter[1][@type='tv.danmaku.ijk.media.player.misc.IjkMediaFormat']]"
			[Register ("format", "(Ltv/danmaku/ijk/media/player/misc/IjkMediaFormat;)Ljava/lang/String;", "GetFormat_Ltv_danmaku_ijk_media_player_misc_IjkMediaFormat_Handler")]
			public virtual unsafe string Format (global::TV.Danmaku.Ijk.Media.Player.Misc.IjkMediaFormat p0)
			{
				if (id_format_Ltv_danmaku_ijk_media_player_misc_IjkMediaFormat_ == IntPtr.Zero)
					id_format_Ltv_danmaku_ijk_media_player_misc_IjkMediaFormat_ = JNIEnv.GetMethodID (class_ref, "format", "(Ltv/danmaku/ijk/media/player/misc/IjkMediaFormat;)Ljava/lang/String;");
				try {
					...
					string __ret;
					if (((object) this).GetType () == ThresholdType)
						__ret = JNIEnv.GetString (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_format_Ltv_danmaku_ijk_media_player_misc_IjkMediaFormat_, __args), JniHandleOwnership.TransferLocalRef);
					else
						__ret = JNIEnv.GetString (JNIEnv.CallNonvirtualObjectMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "format", "(Ltv/danmaku/ijk/media/player/misc/IjkMediaFormat;)Ljava/lang/String;"), __args), JniHandleOwnership.TransferLocalRef);
					return __ret;
				} finally {
				}
			}
		...
		[global::Android.Runtime.Register ("tv/danmaku/ijk/media/player/misc/IjkMediaFormat$Formatter", DoNotGenerateAcw=true)]
		internal partial class FormatterInvoker : Formatter {

			public FormatterInvoker (IntPtr handle, JniHandleOwnership transfer) : base (handle, transfer) {}

			protected override global::System.Type ThresholdType {
				get { return typeof (FormatterInvoker); }
			}

			static IntPtr id_doFormat_Ltv_danmaku_ijk_media_player_misc_IjkMediaFormat_;
			// Metadata.xml XPath method reference: path="/api/package[@name='tv.danmaku.ijk.media.player.misc']/class[@name='IjkMediaFormat.Formatter']/method[@name='doFormat' and count(parameter)=1 and parameter[1][@type='tv.danmaku.ijk.media.player.misc.IjkMediaFormat']]"
			[Register ("doFormat", "(Ltv/danmaku/ijk/media/player/misc/IjkMediaFormat;)Ljava/lang/String;", "GetDoFormat_Ltv_danmaku_ijk_media_player_misc_IjkMediaFormat_Handler")]
			protected override unsafe string DoFormat (global::TV.Danmaku.Ijk.Media.Player.Misc.IjkMediaFormat p0)
			{
				if (id_doFormat_Ltv_danmaku_ijk_media_player_misc_IjkMediaFormat_ == IntPtr.Zero)
					id_doFormat_Ltv_danmaku_ijk_media_player_misc_IjkMediaFormat_ = JNIEnv.GetMethodID (class_ref, "doFormat", "(Ltv/danmaku/ijk/media/player/misc/IjkMediaFormat;)Ljava/lang/String;");
				try {
					JValue* __args = stackalloc JValue [1];
					__args [0] = new JValue (p0);
					string __ret = JNIEnv.GetString (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_doFormat_Ltv_danmaku_ijk_media_player_misc_IjkMediaFormat_, __args), JniHandleOwnership.TransferLocalRef);
					return __ret;
				} finally {
				}
			}
