...
namespace TV.Danmaku.Ijk.Media.Player {
	...
	public partial interface IMediaPlayerOnBufferingUpdateListener : IJavaObject {
		...
		[Register ("onBufferingUpdate", "(Ltv/danmaku/ijk/media/player/IMediaPlayer;I)V", "GetOnBufferingUpdate_Ltv_danmaku_ijk_media_player_IMediaPlayer_IHandler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerOnBufferingUpdateListenerInvoker, Binding_IjkplayerJava")]
...
#pragma warning restore 0649
	...
	public partial interface IMediaPlayerOnCompletionListener : IJavaObject {
		...
		[Register ("onCompletion", "(Ltv/danmaku/ijk/media/player/IMediaPlayer;)V", "GetOnCompletion_Ltv_danmaku_ijk_media_player_IMediaPlayer_Handler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerOnCompletionListenerInvoker, Binding_IjkplayerJava")]
...
#pragma warning restore 0649
	...
	public partial interface IMediaPlayerOnErrorListener : IJavaObject {
		...
		[Register ("onError", "(Ltv/danmaku/ijk/media/player/IMediaPlayer;II)Z", "GetOnError_Ltv_danmaku_ijk_media_player_IMediaPlayer_IIHandler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerOnErrorListenerInvoker, Binding_IjkplayerJava")]
...
#pragma warning restore 0649
	...
	public partial interface IMediaPlayerOnInfoListener : IJavaObject {
		...
		[Register ("onInfo", "(Ltv/danmaku/ijk/media/player/IMediaPlayer;II)Z", "GetOnInfo_Ltv_danmaku_ijk_media_player_IMediaPlayer_IIHandler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerOnInfoListenerInvoker, Binding_IjkplayerJava")]
...
#pragma warning restore 0649
	...
	public partial interface IMediaPlayerOnPreparedListener : IJavaObject {
		...
		[Register ("onPrepared", "(Ltv/danmaku/ijk/media/player/IMediaPlayer;)V", "GetOnPrepared_Ltv_danmaku_ijk_media_player_IMediaPlayer_Handler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerOnPreparedListenerInvoker, Binding_IjkplayerJava")]
...
#pragma warning restore 0649
	...
	public partial interface IMediaPlayerOnSeekCompleteListener : IJavaObject {
		...
		[Register ("onSeekComplete", "(Ltv/danmaku/ijk/media/player/IMediaPlayer;)V", "GetOnSeekComplete_Ltv_danmaku_ijk_media_player_IMediaPlayer_Handler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerOnSeekCompleteListenerInvoker, Binding_IjkplayerJava")]
...
#pragma warning restore 0649
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='tv.danmaku.ijk.media.player']/interface[@name='IMediaPlayer.OnTimedTextListener']"
	[Register ("tv/danmaku/ijk/media/player/IMediaPlayer$OnTimedTextListener", "", "TV.Danmaku.Ijk.Media.Player.IMediaPlayerOnTimedTextListenerInvoker")]
	public partial interface IMediaPlayerOnTimedTextListener : IJavaObject {

		// Metadata.xml XPath method reference: path="/api/package[@name='tv.danmaku.ijk.media.player']/interface[@name='IMediaPlayer.OnTimedTextListener']/method[@name='onTimedText' and count(parameter)=2 and parameter[1][@type='tv.danmaku.ijk.media.player.IMediaPlayer'] and parameter[2][@type='tv.danmaku.ijk.media.player.IjkTimedText']]"
		[Register ("onTimedText", "(Ltv/danmaku/ijk/media/player/IMediaPlayer;Ltv/danmaku/ijk/media/player/IjkTimedText;)V", "GetOnTimedText_Ltv_danmaku_ijk_media_player_IMediaPlayer_Ltv_danmaku_ijk_media_player_IjkTimedText_Handler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerOnTimedTextListenerInvoker, Binding_IjkplayerJava")]
		void OnTimedText (global::TV.Danmaku.Ijk.Media.Player.IMediaPlayer p0, global::TV.Danmaku.Ijk.Media.Player.IjkTimedText p1);

	}

	[global::Android.Runtime.Register ("tv/danmaku/ijk/media/player/IMediaPlayer$OnTimedTextListener", DoNotGenerateAcw=true)]
	internal class IMediaPlayerOnTimedTextListenerInvoker : global::Java.Lang.Object, IMediaPlayerOnTimedTextListener {

		static IntPtr java_class_ref = JNIEnv.FindClass ("tv/danmaku/ijk/media/player/IMediaPlayer$OnTimedTextListener");
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (IMediaPlayerOnTimedTextListenerInvoker); }
		}

		IntPtr class_ref;

		public static IMediaPlayerOnTimedTextListener GetObject (IntPtr handle, JniHandleOwnership transfer)
		{
			return global::Java.Lang.Object.GetObject<IMediaPlayerOnTimedTextListener> (handle, transfer);
		}
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
							JNIEnv.GetClassNameFromInstance (handle), "tv.danmaku.ijk.media.player.IMediaPlayer.OnTimedTextListener"));
			return handle;
		}
		...
		public IMediaPlayerOnTimedTextListenerInvoker (IntPtr handle, JniHandleOwnership transfer) : base (Validate (handle), transfer)
		{
			IntPtr local_ref = JNIEnv.GetObjectClass (((global::Java.Lang.Object) this).Handle);
			this.class_ref = JNIEnv.NewGlobalRef (local_ref);
			JNIEnv.DeleteLocalRef (local_ref);
		...
		static Delegate cb_onTimedText_Ltv_danmaku_ijk_media_player_IMediaPlayer_Ltv_danmaku_ijk_media_player_IjkTimedText_;
#pragma warning disable 0169
		static Delegate GetOnTimedText_Ltv_danmaku_ijk_media_player_IMediaPlayer_Ltv_danmaku_ijk_media_player_IjkTimedText_Handler ()
		{
			if (cb_onTimedText_Ltv_danmaku_ijk_media_player_IMediaPlayer_Ltv_danmaku_ijk_media_player_IjkTimedText_ == null)
				cb_onTimedText_Ltv_danmaku_ijk_media_player_IMediaPlayer_Ltv_danmaku_ijk_media_player_IjkTimedText_ = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr, IntPtr>) n_OnTimedText_Ltv_danmaku_ijk_media_player_IMediaPlayer_Ltv_danmaku_ijk_media_player_IjkTimedText_);
			return cb_onTimedText_Ltv_danmaku_ijk_media_player_IMediaPlayer_Ltv_danmaku_ijk_media_player_IjkTimedText_;
		}

		static void n_OnTimedText_Ltv_danmaku_ijk_media_player_IMediaPlayer_Ltv_danmaku_ijk_media_player_IjkTimedText_ (IntPtr jnienv, IntPtr native__this, IntPtr native_p0, IntPtr native_p1)
		{
			global::TV.Danmaku.Ijk.Media.Player.IMediaPlayerOnTimedTextListener __this = global::Java.Lang.Object.GetObject<global::TV.Danmaku.Ijk.Media.Player.IMediaPlayerOnTimedTextListener> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			global::TV.Danmaku.Ijk.Media.Player.IMediaPlayer p0 = (global::TV.Danmaku.Ijk.Media.Player.IMediaPlayer)global::Java.Lang.Object.GetObject<global::TV.Danmaku.Ijk.Media.Player.IMediaPlayer> (native_p0, JniHandleOwnership.DoNotTransfer);
			global::TV.Danmaku.Ijk.Media.Player.IjkTimedText p1 = global::Java.Lang.Object.GetObject<global::TV.Danmaku.Ijk.Media.Player.IjkTimedText> (native_p1, JniHandleOwnership.DoNotTransfer);
			__this.OnTimedText (p0, p1);
		}
#pragma warning restore 0169

		IntPtr id_onTimedText_Ltv_danmaku_ijk_media_player_IMediaPlayer_Ltv_danmaku_ijk_media_player_IjkTimedText_;
		public unsafe void OnTimedText (global::TV.Danmaku.Ijk.Media.Player.IMediaPlayer p0, global::TV.Danmaku.Ijk.Media.Player.IjkTimedText p1)
		{
			if (id_onTimedText_Ltv_danmaku_ijk_media_player_IMediaPlayer_Ltv_danmaku_ijk_media_player_IjkTimedText_ == IntPtr.Zero)
				id_onTimedText_Ltv_danmaku_ijk_media_player_IMediaPlayer_Ltv_danmaku_ijk_media_player_IjkTimedText_ = JNIEnv.GetMethodID (class_ref, "onTimedText", "(Ltv/danmaku/ijk/media/player/IMediaPlayer;Ltv/danmaku/ijk/media/player/IjkTimedText;)V");
			JValue* __args = stackalloc JValue [2];
			__args [0] = new JValue (p0);
			__args [1] = new JValue (p1);
			JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_onTimedText_Ltv_danmaku_ijk_media_player_IMediaPlayer_Ltv_danmaku_ijk_media_player_IjkTimedText_, __args);
		}

	}

	public partial class MediaPlayerOnTimedTextEventArgs : global::System.EventArgs {

		public MediaPlayerOnTimedTextEventArgs (global::TV.Danmaku.Ijk.Media.Player.IMediaPlayer p0, global::TV.Danmaku.Ijk.Media.Player.IjkTimedText p1)
		{
			this.p0 = p0;
			this.p1 = p1;
		}
		...
		global::TV.Danmaku.Ijk.Media.Player.IjkTimedText p1;
		public global::TV.Danmaku.Ijk.Media.Player.IjkTimedText P1 {
			get { return p1; }
		}
	}

	[global::Android.Runtime.Register ("mono/tv/danmaku/ijk/media/player/IMediaPlayer_OnTimedTextListenerImplementor")]
	internal sealed partial class IMediaPlayerOnTimedTextListenerImplementor : global::Java.Lang.Object, IMediaPlayerOnTimedTextListener {

		object sender;

		public IMediaPlayerOnTimedTextListenerImplementor (object sender)
			: base (
				global::Android.Runtime.JNIEnv.StartCreateInstance ("mono/tv/danmaku/ijk/media/player/IMediaPlayer_OnTimedTextListenerImplementor", "()V"),
				JniHandleOwnership.TransferLocalRef)
		{
			global::Android.Runtime.JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, "()V");
			this.sender = sender;
...
#pragma warning disable 0649
		public EventHandler<MediaPlayerOnTimedTextEventArgs> Handler;
#pragma warning restore 0649

		public void OnTimedText (global::TV.Danmaku.Ijk.Media.Player.IMediaPlayer p0, global::TV.Danmaku.Ijk.Media.Player.IjkTimedText p1)
		{
			var __h = Handler;
			if (__h != null)
				__h (sender, new MediaPlayerOnTimedTextEventArgs (p0, p1));
		}

		internal static bool __IsEmpty (IMediaPlayerOnTimedTextListenerImplementor value)
		{
			return value.Handler == null;
		}
	}
	...
	public partial interface IMediaPlayerOnVideoSizeChangedListener : IJavaObject {
		...
		[Register ("onVideoSizeChanged", "(Ltv/danmaku/ijk/media/player/IMediaPlayer;IIII)V", "GetOnVideoSizeChanged_Ltv_danmaku_ijk_media_player_IMediaPlayer_IIIIHandler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerOnVideoSizeChangedListenerInvoker, Binding_IjkplayerJava")]
...
#pragma warning restore 0649
	...
	public partial interface IMediaPlayer : IJavaObject {
		...
		int AudioSessionId {
			...
			[Register ("getAudioSessionId", "()I", "GetGetAudioSessionIdHandler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")] get;
		}
		...
		long CurrentPosition {
			...
			[Register ("getCurrentPosition", "()J", "GetGetCurrentPositionHandler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")] get;
		}
		...
		string DataSource {
			...
			[Register ("getDataSource", "()Ljava/lang/String;", "GetGetDataSourceHandler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")] get;
			...
			[Register ("setDataSource", "(Ljava/lang/String;)V", "GetSetDataSource_Ljava_lang_String_Handler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")] set;
		}
		...
		long Duration {
			...
			[Register ("getDuration", "()J", "GetGetDurationHandler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")] get;
		}
		...
		bool IsPlayable {
			...
			[Register ("isPlayable", "()Z", "GetIsPlayableHandler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")] get;
		}
		...
		bool IsPlaying {
			...
			[Register ("isPlaying", "()Z", "GetIsPlayingHandler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")] get;
		}
		...
		bool Looping {
			...
			[Register ("isLooping", "()Z", "GetIsLoopingHandler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")] get;
			...
			[Register ("setLooping", "(Z)V", "GetSetLooping_ZHandler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")] set;
		}
		...
		global::TV.Danmaku.Ijk.Media.Player.MediaInfo MediaInfo {
			...
			[Register ("getMediaInfo", "()Ltv/danmaku/ijk/media/player/MediaInfo;", "GetGetMediaInfoHandler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")] get;
		}
		...
		int VideoHeight {
			...
			[Register ("getVideoHeight", "()I", "GetGetVideoHeightHandler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")] get;
		}
		...
		int VideoSarDen {
			...
			[Register ("getVideoSarDen", "()I", "GetGetVideoSarDenHandler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")] get;
		}
		...
		int VideoSarNum {
			...
			[Register ("getVideoSarNum", "()I", "GetGetVideoSarNumHandler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")] get;
		}
		...
		int VideoWidth {
			...
			[Register ("getVideoWidth", "()I", "GetGetVideoWidthHandler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")] get;
		}
		...
		[Register ("getTrackInfo", "()[Ltv/danmaku/ijk/media/player/misc/ITrackInfo;", "GetGetTrackInfoHandler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")]
		...
		[Register ("pause", "()V", "GetPauseHandler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")]
		void Pause ();
		...
		[Register ("prepareAsync", "()V", "GetPrepareAsyncHandler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")]
		void PrepareAsync ();
		...
		[Register ("release", "()V", "GetReleaseHandler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")]
		void Release ();
		...
		[Register ("reset", "()V", "GetResetHandler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")]
		void Reset ();
		...
		[Register ("seekTo", "(J)V", "GetSeekTo_JHandler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")]
		void SeekTo (long p0);
		...
		[Register ("setAudioStreamType", "(I)V", "GetSetAudioStreamType_IHandler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")]
		...
		[Register ("setDataSource", "(Landroid/content/Context;Landroid/net/Uri;)V", "GetSetDataSource_Landroid_content_Context_Landroid_net_Uri_Handler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")]
		...
		[Register ("setDataSource", "(Landroid/content/Context;Landroid/net/Uri;Ljava/util/Map;)V", "GetSetDataSource_Landroid_content_Context_Landroid_net_Uri_Ljava_util_Map_Handler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")]
		...
		[Register ("setDataSource", "(Ljava/io/FileDescriptor;)V", "GetSetDataSource_Ljava_io_FileDescriptor_Handler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")]
		...
		[Register ("setDataSource", "(Ltv/danmaku/ijk/media/player/misc/IMediaDataSource;)V", "GetSetDataSource_Ltv_danmaku_ijk_media_player_misc_IMediaDataSource_Handler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")]
		...
		[Register ("setDisplay", "(Landroid/view/SurfaceHolder;)V", "GetSetDisplay_Landroid_view_SurfaceHolder_Handler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")]
...
[Obsolete (@"deprecated")]
		[Register ("setKeepInBackground", "(Z)V", "GetSetKeepInBackground_ZHandler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")]
...
[Obsolete (@"deprecated")]
		[Register ("setLogEnabled", "(Z)V", "GetSetLogEnabled_ZHandler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")]
		...
		[Register ("setOnBufferingUpdateListener", "(Ltv/danmaku/ijk/media/player/IMediaPlayer$OnBufferingUpdateListener;)V", "GetSetOnBufferingUpdateListener_Ltv_danmaku_ijk_media_player_IMediaPlayer_OnBufferingUpdateListener_Handler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")]
		...
		[Register ("setOnCompletionListener", "(Ltv/danmaku/ijk/media/player/IMediaPlayer$OnCompletionListener;)V", "GetSetOnCompletionListener_Ltv_danmaku_ijk_media_player_IMediaPlayer_OnCompletionListener_Handler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")]
		...
		[Register ("setOnErrorListener", "(Ltv/danmaku/ijk/media/player/IMediaPlayer$OnErrorListener;)V", "GetSetOnErrorListener_Ltv_danmaku_ijk_media_player_IMediaPlayer_OnErrorListener_Handler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")]
		...
		[Register ("setOnInfoListener", "(Ltv/danmaku/ijk/media/player/IMediaPlayer$OnInfoListener;)V", "GetSetOnInfoListener_Ltv_danmaku_ijk_media_player_IMediaPlayer_OnInfoListener_Handler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")]
		...
		[Register ("setOnPreparedListener", "(Ltv/danmaku/ijk/media/player/IMediaPlayer$OnPreparedListener;)V", "GetSetOnPreparedListener_Ltv_danmaku_ijk_media_player_IMediaPlayer_OnPreparedListener_Handler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")]
		...
		[Register ("setOnSeekCompleteListener", "(Ltv/danmaku/ijk/media/player/IMediaPlayer$OnSeekCompleteListener;)V", "GetSetOnSeekCompleteListener_Ltv_danmaku_ijk_media_player_IMediaPlayer_OnSeekCompleteListener_Handler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")]
		void SetOnSeekCompleteListener (global::TV.Danmaku.Ijk.Media.Player.IMediaPlayerOnSeekCompleteListener p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='tv.danmaku.ijk.media.player']/interface[@name='IMediaPlayer']/method[@name='setOnTimedTextListener' and count(parameter)=1 and parameter[1][@type='tv.danmaku.ijk.media.player.IMediaPlayer.OnTimedTextListener']]"
		[Register ("setOnTimedTextListener", "(Ltv/danmaku/ijk/media/player/IMediaPlayer$OnTimedTextListener;)V", "GetSetOnTimedTextListener_Ltv_danmaku_ijk_media_player_IMediaPlayer_OnTimedTextListener_Handler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")]
		void SetOnTimedTextListener (global::TV.Danmaku.Ijk.Media.Player.IMediaPlayerOnTimedTextListener p0);
		...
		[Register ("setOnVideoSizeChangedListener", "(Ltv/danmaku/ijk/media/player/IMediaPlayer$OnVideoSizeChangedListener;)V", "GetSetOnVideoSizeChangedListener_Ltv_danmaku_ijk_media_player_IMediaPlayer_OnVideoSizeChangedListener_Handler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")]
		...
		[Register ("setScreenOnWhilePlaying", "(Z)V", "GetSetScreenOnWhilePlaying_ZHandler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")]
		...
		[Register ("setSurface", "(Landroid/view/Surface;)V", "GetSetSurface_Landroid_view_Surface_Handler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")]
		...
		[Register ("setVolume", "(FF)V", "GetSetVolume_FFHandler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")]
...
[Obsolete (@"deprecated")]
		[Register ("setWakeMode", "(Landroid/content/Context;I)V", "GetSetWakeMode_Landroid_content_Context_IHandler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")]
		...
		[Register ("start", "()V", "GetStartHandler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")]
		void Start ();
		...
		[Register ("stop", "()V", "GetStopHandler:TV.Danmaku.Ijk.Media.Player.IMediaPlayerInvoker, Binding_IjkplayerJava")]
		void Stop ();
...
#pragma warning restore 0169
		...
		IntPtr id_setOnTimedTextListener_Ltv_danmaku_ijk_media_player_IMediaPlayer_OnTimedTextListener_;
		public unsafe void SetOnTimedTextListener (global::TV.Danmaku.Ijk.Media.Player.IMediaPlayerOnTimedTextListener p0)
		{
