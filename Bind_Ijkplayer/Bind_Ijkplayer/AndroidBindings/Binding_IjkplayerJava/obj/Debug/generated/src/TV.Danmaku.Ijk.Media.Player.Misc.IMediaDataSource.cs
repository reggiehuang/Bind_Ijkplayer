...
namespace TV.Danmaku.Ijk.Media.Player.Misc {
	...
	public partial interface IMediaDataSource : IJavaObject {
		...
		long Size {
			...
			[Register ("getSize", "()J", "GetGetSizeHandler:TV.Danmaku.Ijk.Media.Player.Misc.IMediaDataSourceInvoker, Binding_IjkplayerJava")] get;
		}
		...
		[Register ("close", "()V", "GetCloseHandler:TV.Danmaku.Ijk.Media.Player.Misc.IMediaDataSourceInvoker, Binding_IjkplayerJava")]
		void Close ();
		...
		[Register ("readAt", "(J[BII)I", "GetReadAt_JarrayBIIHandler:TV.Danmaku.Ijk.Media.Player.Misc.IMediaDataSourceInvoker, Binding_IjkplayerJava")]
