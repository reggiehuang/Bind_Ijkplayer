...
namespace TV.Danmaku.Ijk.Media.Player {
	...
	public abstract partial class AbstractMediaPlayer : global::Java.Lang.Object, global::TV.Danmaku.Ijk.Media.Player.IMediaPlayer {
		...
		static IntPtr id_notifyOnTimedText_Ltv_danmaku_ijk_media_player_IjkTimedText_;
		// Metadata.xml XPath method reference: path="/api/package[@name='tv.danmaku.ijk.media.player']/class[@name='AbstractMediaPlayer']/method[@name='notifyOnTimedText' and count(parameter)=1 and parameter[1][@type='tv.danmaku.ijk.media.player.IjkTimedText']]"
		[Register ("notifyOnTimedText", "(Ltv/danmaku/ijk/media/player/IjkTimedText;)V", "")]
		protected unsafe void NotifyOnTimedText (global::TV.Danmaku.Ijk.Media.Player.IjkTimedText p0)
		{
			if (id_notifyOnTimedText_Ltv_danmaku_ijk_media_player_IjkTimedText_ == IntPtr.Zero)
				id_notifyOnTimedText_Ltv_danmaku_ijk_media_player_IjkTimedText_ = JNIEnv.GetMethodID (class_ref, "notifyOnTimedText", "(Ltv/danmaku/ijk/media/player/IjkTimedText;)V");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_notifyOnTimedText_Ltv_danmaku_ijk_media_player_IjkTimedText_, __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='tv.danmaku.ijk.media.player']/class[@name='AbstractMediaPlayer']/method[@name='setOnTimedTextListener' and count(parameter)=1 and parameter[1][@type='tv.danmaku.ijk.media.player.IMediaPlayer.OnTimedTextListener']]"
		[Register ("setOnTimedTextListener", "(Ltv/danmaku/ijk/media/player/IMediaPlayer$OnTimedTextListener;)V", "")]
