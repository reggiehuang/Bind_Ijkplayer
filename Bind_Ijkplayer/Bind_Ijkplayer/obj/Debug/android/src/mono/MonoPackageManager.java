...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "Bind_Ijkplayer.dll" comes first in this list. */
		"Bind_Ijkplayer.dll",
		"Binding_IjkplayerArm64.dll",
		"Binding_IjkplayerArmv7A.dll",
		"Binding_IjkplayerX8664.dll",
		"ICE.MediaPlay.Droid.dll",
	};
